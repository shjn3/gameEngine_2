...
var AnimationObject = /** @class */ (function () {
    ...
    AnimationObject.prototype.getNameAnimation = function () {
        return this.nameAnimation;
    };
    AnimationObject.prototype.setNameAnimation = function (nameAnimation) {
        this.nameAnimation = nameAnimation;
    };
    AnimationObject.prototype.setKey = function (key) {
        this.key = key;
    };
    AnimationObject.prototype.getKey = function () {
        return this.key;
    };
    AnimationObject.prototype.create = function (configAnimation) {
        ...
        if (this.game.arrayImageSprite.length > 0) {
            var imageFromSpriteSheet = this.game.arrayImageSprite.filter(function (_e) { return _e.getNameImage() === frames.nameImage; });
